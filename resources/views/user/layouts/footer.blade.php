            ...
            <div class="row">
                <div class="col-lg-5 col-md-6 col-12">
                    ...
                    <div class="single-footer about">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('assets/user/images/logo2.png') }}" alt="#"></a>
                        </div>
                        ...
                        <p class="call">Got Question? Call us 24/7<span><a href="tel:123456789" class="ti-mobile"> +84 123 456
                                    789</a></span></p>
                    </div>
                    <!-- End Single Widget -->
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-footer social">
                        ...
                        <div class="contact">
                            <ul>
                                <li class="ti-user"> Team IT5</li>
                                <li class="ti-location-pin"> Duy Tan University</li>
                                <li class="ti-email"> eshop@teamIT5.com</li>
                                <li class="ti-mobile"> +84 123 456 789</li>
                            </ul>
                        </div>
                        <!-- End Single Widget -->
                        <ul>
