        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    ...
                    <div class="col-4">
                        <a href="{{ route('admin.brands.create') }}"><button class="btn btn-primary">Add
                                brand</button></a>
                    </div>
                </div>
                <div class="row">
                                            ...
                                            <tr role="row">
                                                <th>Name
                                                    <div class="btn-group-vertical">
                                                        <a data-sort="asc" class="btn btn-xs btn-link sort-search p-0">
                                                            <i class="fas fa-sort-up"></i>
                                                        </a>
                                                        <a data-sort="desc" class="btn btn-xs btn-link sort-search p-0">
                                            ...
                                            @foreach ($brands as $brand)
                                                <tr role="row">
                                                    ...
                                                    <td class="d-flex justify-content-right">
                                                        ...
                                                        <form onsubmit="return confirm(trans('messages.delete.brand'))"
...
@section('js')
    ...
    <script>
        ...
        $('.sort-search').click(function()
        {
            ...
            window.location.href = "{{ route('admin.brands.index') }}?" + $.param(query);
        })
    </script>
@endsection
